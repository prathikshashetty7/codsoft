...
from PIL import Image, ImageTk  # You might need to install Pillow with `pip install pillow`
import random
...
def play_game(user_choice):
    ...
    # Show "Try Again" button after each round
...
root.configure(bg="#efd7f3")  # Light blue background
